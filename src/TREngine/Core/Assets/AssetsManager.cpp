...
void AssetsManager::loadBuiltinAssets()
{
	...
	auto fs_perlin = std::make_shared<RawShader>(_resourceManager, ReadAllStringFromFile("Resources/Shaders/perlinNoise.frag").c_str(), ShaderType::FRAGMENT_SHADER, "perlinNoise.frag");
