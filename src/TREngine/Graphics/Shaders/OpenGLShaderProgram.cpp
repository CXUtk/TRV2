...
OpenGLShaderProgram::OpenGLShaderProgram(const std::shared_ptr<IRawShader>& vertexShader, const std::shared_ptr<IRawShader>& fragmentShader) : IShaderProgram(vertexShader, fragmentShader)
{
